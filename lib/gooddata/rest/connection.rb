  ...
  module Rest
    ...
    class Connection
      ...
      def download(what, where, options = {})
        ...
        url = URI.join("#{server}", base_url, what).to_s  #CGI.escape(what)).to_s
        ...
        GoodData::Rest::Connection.retryable(:tries => Helpers::GD_MAX_RETRY, :refresh_token => proc { refresh_token }, :on => RestRetry) do
